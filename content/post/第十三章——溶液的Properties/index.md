---
title: "第十三章——Properties of Solutions"
description: "溶液的性质：溶解度、依数性、胶体"
date: 2026-04-29
draft: false
math: true
tags: [化学, 溶液, 依数性]
...
> 边学边整理，期末直接背。关键术语保留英文，解释用中文。

---

## Ch.13 Properties of Solutions（溶液的性质）

---

### 1. 基本概念

- **Solution（溶液）**：两种或以上纯物质的均匀混合物
- **Solute（溶质）** → 被分散的物质
- **Solvent（溶剂）** → 分散溶质的介质
- 溶液也可以是固体（合金）或气体（空气）
...
| 因素 | 说明 |
|------|------|
| **Entropy（熵）↑** | 物质混合 → 混乱度↑ → 自发趋势 |
| **Intermolecular interactions（分子间作用力）** | 溶质–溶质、溶剂–溶剂、溶质–溶剂 三者竞争 |

⚠️ 溶质和溶剂之间的分子间力必须**足够强**，才能竞争过溶质内部和溶剂内部的作用力。

**Solvation（溶剂化）**：溶剂分子包围溶质粒子的过程。溶剂为水时称为 **Hydration（水合）**。
...
### 4. Dissolution ≠ Chemical Reaction

- **Dissolution（溶解）是 physical change（物理变化）** → 蒸发溶剂可回收原溶质
- 如果回收不了 → 实际上是发生了**化学反应**
...
| 类型 | 定义 | 特点 |
|------|------|------|
| **Saturated（饱和）** | 溶剂量已溶解最大量溶质 | **dynamic equilibrium（动态平衡）**：dissolution = crystallization |
| **Unsaturated（不饱和）** | 溶质量少于饱和所需 | 还能继续溶解 |
| **Supersaturated（过饱和）** | 溶质量超过正常溶解度 | **不稳定**，加 seed crystal 或 scratching 即结晶 |

⚠️ **Solubility（溶解度）定义**：一定温度下，某固态物质在 **100 g 溶剂** 中达到饱和时所溶解的质量。

---

### 6. 影响 Solubility 的因素

#### 6.1 "Like Dissolves Like"（相似相溶）

| Solute（溶质） | Solvent（溶剂） | 结果 |
|------|------|------|
| Polar（极性） | Polar（极性） | 溶 ✔ |
| Nonpolar（非极性） | Nonpolar（非极性） | 溶 ✔ |
| Polar | Nonpolar | 不溶 ✘ |

- **Glucose（葡萄糖）**（有 H-bonding）→ 溶于水 ✔
- **Cyclohexane（环己烷）**（只有 dispersion forces）→ 不溶于水 ✘
- **Vitamin A** → 溶于非极性溶剂（脂肪）| **Vitamin C** → 溶于极性溶剂（水）

#### 6.2 压力效应 — Henry's Law（亨利定律）
...
📝 **生活例子**：碳酸饮料冷藏更"气泡足"；温水里氧气少

---

### 7. 浓度表示法（Ways of Expressing Concentration）
...
### 8. Colligative Properties（依数性）

> 只与溶质**粒子数量**有关，与溶质**种类**无关。
...
理想溶液在**全部浓度范围内**都服从 Raoult's Law，需要满足：
...
m = moles of solute / mass of solvent (kg)
  = (m_B / M_B) / m_A            ← m_B：溶质质量(g)，M_B：摩尔质量(g/mol)
  = m_B / (M_B · m_A)

代入 ΔT_f = K_f · m：
ΔT_f = K_f · m_B / (M_B · m_A)
...
### 12. Osmosis（渗透）& Osmotic Pressure（渗透压）
...
| 类型 | 定义 | 对细胞的影响 |
|------|------|-----------|
| **Isotonic（等渗）** | 内外渗透压相等 | 正常 |
| **Hypertonic（高渗）** | 外 > 内 | 水流出 → **crenation（皱缩）** |
| **Hypotonic（低渗）** | 外 < 内 | 水流入 → **hemolysis（溶血）** |
...
- **定义**：粒子直径 **5~1000 nm**，介于真溶液和悬浮液之间

- **Tyndall Effect（丁达尔效应）**：胶体粒子散射光线 → 可见光路

| 类型 | 特点 |
|------|------|
| **Hydrophilic colloid（亲水胶体）** | 与水亲和，稳定 |
| **Hydrophobic colloid（疏水胶体）** | 怕水，需 **emulsifier（乳化剂）** 稳定 |

📝 **词根记忆法（-philic vs -phobic）**：

| 词根 | 来源 | 含义 | 例词 |
|------|------|------|------|
| **-philic** | 希腊语 *philia* = 爱 | → 喜欢、亲和 | **hydrophilic**（hydro=水 + philic=爱 → 亲水） |
| **-phobic** | 希腊语 *phobia* = 恐惧 | → 讨厌、排斥 | **hydrophobic**（hydro=水 + phobic=怕 → 疏水） |
...
看分子结构是否同时具备**两亲性（amphiphilic / amphipathic）**：

```
疏水端（hydrophobic tail）    亲水端（hydrophilic head）
   长碳氢链（nonpolar）           极性/离子基团（polar/ionic）
       │                               │
  CH₃(CH₂)₁₄CH₂ — C(=O)O⁻ Na⁺
       ↑                               ↑
  亲油（爱脂肪）                    亲水（爱水）
...
**判断三步走**：
1. **找疏水端**：有没有长的 **hydrocarbon chain（碳氢链）**？越长越疏水
...
- 加热
- 加 electrolyte（电解质）
- **Dialysis（渗析）**：用 semipermeable membrane 分离离子和胶体粒子
...
1. **"Like dissolves like" 指的是 ______ 的相似性**
   → **intermolecular attractive forces（分子间作用力）**

2. **下列哪种与水 miscible（互溶）？**
   CH₃OH / CH₄ / C₆H₆ / CH₃CH₂OCH₂CH₃
   → **CH₃OH**（甲醇，极性，有 H-bonding）

3. **碳链越长，与水互溶性越差**：CH₃OH > CH₃CH₂OH > CH₃CH₂CH₂OH > CH₃CH₂CH₂CH₂OH

4. **气体溶解度随压力增大而增大**
   → **Henry's Law**（不是 Boyle / Charles / Raoult）
...
11. **下列哪个不是 colloid？** Butter / Smoke / Whipped cream / **Salt water**

---

> 🗓 最后更新：2026-04-28 | 来源：Chapter 13 课件
